...
describe('GlobalNavigationContext', () => {
  describe('GlobalNavigationProvider', () => {
    it('初期状態で isNavigationOpen が true であること', () => {
    ...
    it('onNavigationOpenToggle を呼び出すと isNavigationOpen が false に変わること', () => {
      const wrapper = ({ children }: { children: React.ReactNode }) => (
        <GlobalNavigationProvider>{children}</GlobalNavigationProvider>
      );
    ...
    it('onNavigationOpenToggle を2回呼び出すと isNavigationOpen が true に戻ること', () => {
      const wrapper = ({ children }: { children: React.ReactNode }) => (
        <GlobalNavigationProvider>{children}</GlobalNavigationProvider>
      );
