# AGENTS.md - Development Guide for Space Playground Kit

This file provides agents with guidance when working in this repository.

## Project Overview

Space Playground Kit is a comprehensive React component library that implements the Tailwind CSS system in its own way.
